...
- **Transparency log as the *only* anchor target:** rejected. Rekor is adopted as an optional *additional* destination (above), not a replacement for customer-held or managed destinations.
